  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'neon-accent': '0 0 20px hsl(var(--accent) / 0.5), 0 0 40px hsl(var(--accent) / 0.3)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'gradient-glow': 'linear-gradient(135deg, hsl(var(--primary)), hsl(var(--accent)))',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          ...
          "50%": { boxShadow: "0 0 40px hsl(var(--primary) / 0.5), 0 0 60px hsl(var(--accent) / 0.2)" },
        },
        "shimmer": {
